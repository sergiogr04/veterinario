                ...
                <tbody class="bg-white divide-y divide-gray-200 text-sm">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 space-x-2">
                            <button onclick="verMascota({{ $mascota->id_mascota }})" class="text-blue-600 hover:text-blue-800">👁 Ver</button>
                            <button onclick="editarMascota({{ $mascota->id_mascota }})" class="text-yellow-600 hover:text-yellow-800">✏️ Editar</button>
                            <button onclick="eliminarMascota({{ $mascota->id_mascota }})" class="text-red-600 hover:text-red-800">🗑 Eliminar</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
